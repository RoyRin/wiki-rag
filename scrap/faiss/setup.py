...
assert (
    found_swigfaiss_generic or found_swigfaiss_avx2 or found_swigfaiss_avx512
    or found_swigfaiss_avx512_spr or found_swigfaiss_sve
...
if found_swigfaiss_avx512_spr:
    ...
    shutil.copyfile(swigfaiss_avx512_spr_lib,
                    f"faiss/_swigfaiss_avx512_spr{ext}")

...
def handle_Index(the_class):
    ...
    def replacement_search_and_reconstruct(self,
                                           x,
                                           k,
                                           *,
                                           params=None,
        ...
        self.search_and_reconstruct_c(n, swig_ptr(x), k, swig_ptr(D),
                                      swig_ptr(I), swig_ptr(R), params)
        return D, I, R

    def replacement_search_and_return_codes(self,
                                            x,
                                            k,
                                            *,
        ...
        self.search_and_return_codes_c(n, swig_ptr(x), k, swig_ptr(D),
                                       swig_ptr(I), swig_ptr(codes),
                                       include_listnos, params)
        return D, I, codes
    ...
    def replacement_search_preassigned(self,
                                       x,
                                       k,
                                       Iq,
                                       Dq,
        ...
        self.search_preassigned_c(n, swig_ptr(x), k,
                                  swig_ptr(Iq), swig_ptr(Dq), swig_ptr(D),
                                  swig_ptr(I), False)
        return D, I

    def replacement_range_search_preassigned(self,
                                             x,
                                             thresh,
                                             Iq,
                                             Dq,
        ...
        thresh = float(thresh)
        res = RangeSearchResult(n)
        self.range_search_preassigned_c(n, swig_ptr(x), thresh, swig_ptr(Iq),
                                        swig_ptr(Dq), res)
        # get pointers and copy them
        lims = rev_swig_ptr(res.lims, n + 1).copy()
        nd = int(lims[-1])
...
def handle_AutoTuneCriterion(the_class):
    ...
    def replacement_set_groundtruth(self, D, I):
        ...
        self.set_groundtruth_c(self.gt_nnn,
                               swig_ptr(D) if D else None, swig_ptr(I))
...
def handle_Linear(the_class):
    ...
    def from_torch(self, linear):
        ...
        faiss.copy_array_to_vector(linear.weight.data.numpy().ravel(),
                                   self.weight)
...
def handle_QINCoStep(the_class):
    ...
    def from_torch(self, step):
        ...
        assert (step.d, step.K, step.L, step.h) == (self.d, self.K, self.L,
                                                    self.h)
...
def handle_QINCo(the_class):
    ...
    def from_torch(self, qinco):
        ...
        assert ((qinco.d, qinco.K, qinco.L, qinco.M,
                 qinco.h) == (self.d, self.K, self.L, self.M, self.h))
